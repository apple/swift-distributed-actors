...
#APP_DIRECTORY=./XPCLibCaller.app
#CFBUNDLEEXECUTABLE=XPCLibCaller
APP_DIRECTORY=./XPCActorCaller.app
CFBUNDLEEXECUTABLE=XPCActorCaller

# C service impl
#XPCEXECUTABLE=XPCServiceProvider

# Actor service impl
XPCEXECUTABLE=XPCActorServiceProvider
