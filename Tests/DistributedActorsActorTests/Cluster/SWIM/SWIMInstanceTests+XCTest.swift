...
extension SWIMInstanceTests {
   ...
   static var allTests : [(String, (SWIMInstanceTests) -> () throws -> Void)] {
      return [
                ...
                ("test_onSelfGossip_withAlive_shouldReturn_none", test_onSelfGossip_withAlive_shouldReturn_none),
                ("test_onSelfGossip_withSuspectAndSameIncarnation_shouldIncrementIncarnationAndReturn_none", test_onSelfGossip_withSuspectAndSameIncarnation_shouldIncrementIncarnationAndReturn_none),
                ("test_onSelfGossip_withSuspectAndLowerIncarnation_shouldNotIncrementIncarnationAndReturn_none", test_onSelfGossip_withSuspectAndLowerIncarnation_shouldNotIncrementIncarnationAndReturn_none),
                ("test_onSelfGossip_withSuspectAndHigherIncarnation_shouldNotIncrementIncarnationAndReturn_noneWithWarning", test_onSelfGossip_withSuspectAndHigherIncarnation_shouldNotIncrementIncarnationAndReturn_noneWithWarning),
                ("test_onSelfGossip_withDead_shouldReturn_shutdown", test_onSelfGossip_withDead_shouldReturn_shutdown),
