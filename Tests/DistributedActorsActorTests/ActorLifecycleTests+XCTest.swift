...
extension ActorLifecycleTests {
   ...
   static var allTests : [(String, (ActorLifecycleTests) -> () throws -> Void)] {
      return [
                ("test_shouldNotAllowStartingWith_Same", test_shouldNotAllowStartingWith_Same),
                ("test_shouldNotAllowStartingWith_Unhandled", test_shouldNotAllowStartingWith_Unhandled),
