...
final class ActorNamingTests: XCTestCase {
    ...
    func test_makeName_sequentialNumeric() {
        var context = ActorNamingContext()
        let naming = ActorNaming(_unchecked: .prefixed(prefix: "hello", suffixScheme: .sequentialNumeric))
    ...
    func test_makeName_letters() {
        var context = ActorNamingContext()
        let naming = ActorNaming(_unchecked: .prefixed(prefix: "hello", suffixScheme: .letters))
