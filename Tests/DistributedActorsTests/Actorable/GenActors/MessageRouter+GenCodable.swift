...
// ==== ----------------------------------------------------------------------------------------------------------------
// MARK: DO NOT EDIT: Codable conformance for MessageRouter.Message
// TODO: This will not be required, once Swift synthesizes Codable conformances for enums with associated values 

extension MessageRouter.Message {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .registerTarget:
            ...
            let actor = try container.decode(AnyActor.MessageTarget.self, forKey: CodingKeys.registerTarget_actor)
            self = .registerTarget(identifier, actor: actor)
        case .dispatchMessage:
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .registerTarget(let identifier, let actor):
            ...
            try container.encode(actor, forKey: CodingKeys.registerTarget_actor)
