...
final class CRDTReplicatorShellTests: ClusteredNodesTestBase {
    ...
    func test_OperationExecution_consistency_atLeast_exceedAllowedRemoteFailures() throws {
        self.setUpLocal()
    ...
    func test_OperationExecution_consistency_quorum() throws {
        ...
        localConfirmed.remoteConfirmationsNeeded.shouldEqual(3) // quorum = (5 + 1) / 2 + 1 = 4; needed = 4 - 1 (local)
        localConfirmed.fulfilled.shouldBeFalse()
