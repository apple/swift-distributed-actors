...
extension SWIMInstanceTests {
    static var allTests: [(String, (SWIMInstanceTests) -> () throws -> Void)] {
        return [
            ...
            ("test_mark_shouldNotApplyOlderStatus_suspect", test_mark_shouldNotApplyOlderStatus_suspect),
            ...
            ("test_onPingRequestResponse_storeIndividualSuspicions", test_onPingRequestResponse_storeIndividualSuspicions),
            ...
            ("test_onGossipPayload_other_withNewSuspicion_shouldStoreIndividulalSuspicions", test_onGossipPayload_other_withNewSuspicion_shouldStoreIndividulalSuspicions),
            ("test_onGossipPayload_other_shouldNotApplyGossip_whenHaveEnoughSuspectedBy", test_onGossipPayload_other_shouldNotApplyGossip_whenHaveEnoughSuspectedBy),
            ("test_onGossipPayload_other_shouldNotExceedMaximumSuspectedBy", test_onGossipPayload_other_shouldNotExceedMaximumSuspectedBy),
            ...
            ("test_onPingRequestResponse_incrementLHAMultiplier_whenMissedNack", test_onPingRequestResponse_incrementLHAMultiplier_whenMissedNack),
            ("test_onPingRequestResponse_decrementLHAMultiplier_whenGotAck", test_onPingRequestResponse_decrementLHAMultiplier_whenGotAck),
            ("test_onPingRequestResponse_incrementLHAMultiplier_whenRefuteSuspicion_onPing", test_onPingRequestResponse_incrementLHAMultiplier_whenRefuteSuspicion_onPing),
            ("test_onPingRequestResponse_notIncrementLHAMultiplier_whenSeeOldSuspicion_onPing", test_onPingRequestResponse_notIncrementLHAMultiplier_whenSeeOldSuspicion_onPing),
            ("test_onPingRequestResponse_notIncrementLHAMultiplier_whenSeeOldSuspicion_onGossip", test_onPingRequestResponse_notIncrementLHAMultiplier_whenSeeOldSuspicion_onGossip),
            ("test_onPingRequestResponse_incrementLHAMultiplier_whenRefuteSuspicion_onGossip", test_onPingRequestResponse_incrementLHAMultiplier_whenRefuteSuspicion_onGossip),
            ("test_onPingRequestResponse_dontChangeLHAMultiplier_whenGotNack", test_onPingRequestResponse_dontChangeLHAMultiplier_whenGotNack),
