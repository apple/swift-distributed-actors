...
extension SupervisionTests {
    static var allTests: [(String, (SupervisionTests) -> () throws -> Void)] {
        return [
            ...
            ("test_restartSupervised_fatalError_shouldRestartWithExponentialBackoff", test_restartSupervised_fatalError_shouldRestartWithExponentialBackoff),
            ...
            ("test_restart_fatalError_shouldHandleFailureWhenInterpretingStartAfterFailure", test_restart_fatalError_shouldHandleFailureWhenInterpretingStartAfterFailure),
            ("test_restart_throws_shouldFailAfterMaxFailuresInSetup", test_restart_throws_shouldFailAfterMaxFailuresInSetup),
            ("test_restart_fatalError_shouldFailAfterMaxFailuresInSetup", test_restart_fatalError_shouldFailAfterMaxFailuresInSetup),
            ...
            ("test_supervisor_fatalError_shouldFailIrrecoverablyIfFailingToHandle_PreRestartSignal", test_supervisor_fatalError_shouldFailIrrecoverablyIfFailingToHandle_PreRestartSignal),
            ...
            ("test_supervisor_fatalError_shouldFailIrrecoverablyIfFailingToHandle_PreRestartSignal_withBackoff", test_supervisor_fatalError_shouldFailIrrecoverablyIfFailingToHandle_PreRestartSignal_withBackoff),
            ...
            ("test_supervisor_fatalError_shouldRestartWhenFailingInDispatcherClosure", test_supervisor_fatalError_shouldRestartWhenFailingInDispatcherClosure),
