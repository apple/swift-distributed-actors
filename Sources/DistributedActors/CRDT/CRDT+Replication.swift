...
extension CRDT {
    internal enum Replication {
        ...
        // Messages from `CRDT.Replicator` to CRDT instance owner (i.e. `CRDT.ActorOwned`)
...
extension CRDT.Replicator {
    enum LocalCommand: NoSerializationVerification {
        ...
        case register(ownerRef: ActorRef<CRDT.Replication.DataOwnerMessage>, id: CRDT.Identity, data: AnyStateBasedCRDT, replyTo: ActorRef<RegisterResult>?)
        ...
        case write(_ id: CRDT.Identity, _ data: AnyStateBasedCRDT, consistency: OperationConsistency, timeout: TimeAmount, replyTo: ActorRef<WriteResult>)
        // Perform read from at least `consistency` members
        case read(_ id: CRDT.Identity, consistency: OperationConsistency, timeout: TimeAmount, replyTo: ActorRef<ReadResult>)
        // Perform delete to at least `consistency` members
        case delete(_ id: CRDT.Identity, consistency: OperationConsistency, timeout: TimeAmount, replyTo: ActorRef<DeleteResult>)
...
extension CRDT.Replicator {
    enum RemoteCommand {
        ...
        case writeDelta(_ id: CRDT.Identity, delta: AnyStateBasedCRDT, replyTo: ActorRef<WriteResult>)
        ...
        case read(_ id: CRDT.Identity, replyTo: ActorRef<ReadResult>)
        ...
        case delete(_ id: CRDT.Identity, replyTo: ActorRef<DeleteResult>)
