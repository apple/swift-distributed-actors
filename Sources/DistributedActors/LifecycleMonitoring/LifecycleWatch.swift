...
public extension LifecycleWatchContainer {
    ...
    func unwatch<Watchee>(
        ...
        let addressableWatchee = system._resolveUntyped(context: TraversalResolveContext(address: watcheeAddress, system: system))
        let addressableMyself = system._resolveUntyped(context: TraversalResolveContext(address: watcherAddress, system: system))
