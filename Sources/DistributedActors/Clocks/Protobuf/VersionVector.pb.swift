...
public struct _ProtoVersionReplicaID {
  ...
  public var actorAddress: _ProtoActorAddress {
    get {
      if case .actorAddress(let v)? = value {return v}
      return _ProtoActorAddress()
    }
    set {value = .actorAddress(newValue)}
  }
  ...
  public enum OneOf_Value: Equatable {
    ...
    public static func ==(lhs: _ProtoVersionReplicaID.OneOf_Value, rhs: _ProtoVersionReplicaID.OneOf_Value) -> Bool {
      ...
      switch (lhs, rhs) {
      case (.actorAddress, .actorAddress): return {
        guard case .actorAddress(let l) = lhs, case .actorAddress(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
extension _ProtoVersionReplicaID: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // https://github.com/apple/swift-protobuf/issues/1182
    switch self.value {
    case .actorAddress?: try {
      guard case .actorAddress(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .uniqueNode?: try {
