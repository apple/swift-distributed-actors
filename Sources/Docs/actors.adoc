...
already are albeit perhaps more implicitly than explicitly -- ith actors transitions can be modeled more explicitly
...
however they do not provide addressable identities which are able to _keep state_ and communicate over network -- and this is where actors excel at.
