...
public nonisolated struct _ProtoManifest: Sendable {
...
nonisolated extension _ProtoManifest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "Manifest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}serializerID\0\u{1}hint\0")
