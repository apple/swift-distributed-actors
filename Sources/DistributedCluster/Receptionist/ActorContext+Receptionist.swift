...
extension _ActorContext {
    ...
    ///
    /// - SeeAlso: `DistributedCluster.Receptionist`, for the system wide receptionist API
...
extension _ActorContext {
    ...
    ///
    /// - SeeAlso: `DistributedCluster.Receptionist` for the `_ActorRef<Message>` version of this API.
