...
extension DistributedReception {
    public struct GuestListing<Guest: DistributedActor>: AsyncSequence, Sendable
...
internal final class DistributedReceptionistStorage {
    ...
    func removeSubscription(
        key: AnyDistributedReceptionKey,
        subscription: AnyDistributedReceptionListingSubscription
    ) -> Set<AnyDistributedReceptionListingSubscription>? {
    ...
    /// - returns: `true` if the value was a newly inserted value, `false` otherwise
    private func addTo<Value: Hashable>(
        dict: inout [AnyDistributedReceptionKey: OrderedSet<Value>],
        key: AnyDistributedReceptionKey,
        value: Value
    ) -> Bool {
    ...
    /// - returns: `true` if the value was a newly inserted value, `false` otherwise
    private func addTo<Value: Hashable>(
        dict: inout [AnyDistributedReceptionKey: Set<Value>],
        key: AnyDistributedReceptionKey,
        value: Value
    ) -> Bool {
        guard !(dict[key]?.contains(value) ?? false) else {
    ...
    private func removeFrom<Value: Hashable>(
        dict: inout [AnyDistributedReceptionKey: OrderedSet<Value>],
        key: AnyDistributedReceptionKey,
        value: Value
    ) -> OrderedSet<Value>? {
...
internal final class AnyDistributedReceptionListingSubscription: Hashable, @unchecked Sendable, CustomStringConvertible
{
    ...
    static func == (
        lhs: AnyDistributedReceptionListingSubscription,
        rhs: AnyDistributedReceptionListingSubscription
    ) -> Bool {
    ...
    var description: String {
        var string =
            "AnyDistributedReceptionListingSubscription(subscriptionID: \(subscriptionID), key: \(key), , seenActorRegistrations: \(seenActorRegistrations)"
        #if DEBUG
