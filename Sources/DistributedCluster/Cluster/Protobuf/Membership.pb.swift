...
public nonisolated enum _ProtoClusterMemberReachability: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public nonisolated enum _ProtoClusterMemberStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unspecified // = 0
  case joining // = 1
  case up // = 2
...
public nonisolated struct _ProtoClusterMembership: Sendable {
  ...
  public var leaderNode: _ProtoClusterNode {
    get {_leaderNode ?? _ProtoClusterNode()}
    set {_leaderNode = newValue}
  }
  /// Returns true if `leaderNode` has been explicitly set.
  public var hasLeaderNode: Bool {self._leaderNode != nil}
  ...
  fileprivate var _leaderNode: _ProtoClusterNode? = nil
}

public nonisolated struct _ProtoClusterMember: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct _ProtoClusterMembershipGossip: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var membership: _ProtoClusterMembership {
    get {_membership ?? _ProtoClusterMembership()}
    set {_membership = newValue}
  }
  /// Returns true if `membership` has been explicitly set.
  public var hasMembership: Bool {self._membership != nil}
  ...
  public var ownerClusterNodeID: UInt64 = 0

  public var seenTable: _ProtoClusterMembershipSeenTable {
    get {_seenTable ?? _ProtoClusterMembershipSeenTable()}
    set {_seenTable = newValue}
  }
  /// Returns true if `seenTable` has been explicitly set.
  public var hasSeenTable: Bool {self._seenTable != nil}
...
public nonisolated struct _ProtoClusterMembershipSeenTable: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct _ProtoClusterMembershipSeenTableRow: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var version: _ProtoVersionVector {
    get {_version ?? _ProtoVersionVector()}
...
nonisolated extension _ProtoClusterMemberReachability: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CLUSTER_MEMBER_REACHABILITY_UNSPECIFIED\0\u{1}CLUSTER_MEMBER_REACHABILITY_REACHABLE\0\u{1}CLUSTER_MEMBER_REACHABILITY_UNREACHABLE\0")
}

nonisolated extension _ProtoClusterMemberStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CLUSTER_MEMBER_STATUS_UNSPECIFIED\0\u{1}CLUSTER_MEMBER_STATUS_JOINING\0\u{1}CLUSTER_MEMBER_STATUS_UP\0\u{1}CLUSTER_MEMBER_STATUS_DOWN\0\u{1}CLUSTER_MEMBER_STATUS_LEAVING\0\u{1}CLUSTER_MEMBER_STATUS_REMOVED\0")
}

nonisolated extension _ProtoClusterMembership: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterMembership"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}members\0\u{1}leaderNode\0")
...
nonisolated extension _ProtoClusterMember: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterMember"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}node\0\u{1}status\0\u{1}reachability\0\u{1}upNumber\0")
...
nonisolated extension _ProtoClusterMembershipGossip: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterMembershipGossip"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}membership\0\u{1}ownerClusterNodeID\0\u{1}seenTable\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.ownerClusterNodeID) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.ownerClusterNodeID != 0 {
      try visitor.visitSingularUInt64Field(value: self.ownerClusterNodeID, fieldNumber: 2)
    }
    try { if let v = self._seenTable {
  ...
  public static func ==(lhs: _ProtoClusterMembershipGossip, rhs: _ProtoClusterMembershipGossip) -> Bool {
    ...
    if lhs.ownerClusterNodeID != rhs.ownerClusterNodeID {return false}
...
nonisolated extension _ProtoClusterMembershipSeenTable: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension _ProtoClusterMembershipSeenTableRow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterMembershipSeenTableRow"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}nodeID\0\u{1}version\0")
