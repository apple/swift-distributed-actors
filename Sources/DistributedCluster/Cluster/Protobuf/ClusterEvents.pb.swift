...
public nonisolated struct _ProtoClusterEvent: Sendable {
...
public nonisolated struct _ProtoClusterMembershipChange: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct _ProtoClusterLeadershipChange: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var oldLeader: _ProtoClusterMember {
    get {_oldLeader ?? _ProtoClusterMember()}
    set {_oldLeader = newValue}
  }
  /// Returns true if `oldLeader` has been explicitly set.
  public var hasOldLeader: Bool {self._oldLeader != nil}
  ...
  public var newLeader: _ProtoClusterMember {
    get {_newLeader ?? _ProtoClusterMember()}
    set {_newLeader = newValue}
  }
  /// Returns true if `newLeader` has been explicitly set.
  public var hasNewLeader: Bool {self._newLeader != nil}
...
nonisolated extension _ProtoClusterEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterEvent"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}snapshot\0\u{1}membershipChange\0\u{1}leadershipChange\0")
...
nonisolated extension _ProtoClusterMembershipChange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterMembershipChange"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}node\0\u{1}fromStatus\0\u{1}toStatus\0")
...
nonisolated extension _ProtoClusterLeadershipChange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterLeadershipChange"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}oldLeader\0\u{1}newLeader\0")
