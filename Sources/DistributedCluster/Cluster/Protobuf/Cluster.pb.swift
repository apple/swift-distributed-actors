...
public nonisolated struct _ProtoClusterShellMessage: Sendable {
...
public nonisolated struct _ProtoClusterInbound: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct _ProtoClusterRestInPeace: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasTargetNode: Bool {self._targetNode != nil}
  ...
  public var fromNode: _ProtoClusterNode {
    get {_fromNode ?? _ProtoClusterNode()}
    set {_fromNode = newValue}
  }
  /// Returns true if `fromNode` has been explicitly set.
  public var hasFromNode: Bool {self._fromNode != nil}
  ...
  fileprivate var _fromNode: _ProtoClusterNode? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

nonisolated extension _ProtoClusterShellMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterShellMessage"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}clusterEvent\0\u{1}inbound\0")
...
nonisolated extension _ProtoClusterInbound: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterInbound"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}restInPeace\0")
...
nonisolated extension _ProtoClusterRestInPeace: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ClusterRestInPeace"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}targetNode\0\u{1}fromNode\0")
