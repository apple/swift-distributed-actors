...
Or, if all we want to do is sending messages to the actor singleton:
...
NOTE: The same code snippets are applicable to systems that do not have cluster enabled. No adjustments required.
