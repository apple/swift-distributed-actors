...
> from how they are serialized. Built-in support for swift:Codable[], https://developers.google.com/protocol-buffers/[Protocol Buffers],
> as well as custom serializers is provided.
