...
happens: via asynchronous message passing. Actor take this observation and make it the core principle of anything built using them:
...
are able to be referred to other parts of a system using api:ActorRef[class]s.
