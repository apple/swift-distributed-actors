...
> _Everything_ in an Actor system happens within some actors' api:Behavior[struct].
...
The pattern involves exposing, along with a behavior that users may spawn also an api:Props[class] instance with
