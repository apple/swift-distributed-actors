...
Use `--help` to learn about available extra options that can be passed to the source generator (including varying log levels etc).
...
More advanced features of the source generator are documented in <<advanced_genactors_usage>>.
...
[source]
----
include::{dir_sact_doc_tests}/Actorable/ActorableDocExamples.swift[tag=disable_codable_gen]
----
